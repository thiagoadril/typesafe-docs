...
- [Request structure](https://docs.typesafe.ai/primitives/choice#request-structure)
- [Response structure](https://docs.typesafe.ai/primitives/choice#response-structure)
- [Good practice: ask more than one question per call](https://docs.typesafe.ai/primitives/choice#good-practice-ask-more-than-one-question-per-call)
- [A more complex example](https://docs.typesafe.ai/primitives/choice#a-more-complex-example)
- [Structured instructions and criteria](https://docs.typesafe.ai/primitives/choice#structured-instructions-and-criteria)
