...
- [Check it out in action](https://docs.typesafe.ai/demos/smart-home#check-it-out-in-action)
- [How it works](https://docs.typesafe.ai/demos/smart-home#how-it-works)
  - [Speculative fan-out](https://docs.typesafe.ai/demos/smart-home#speculative-fan-out)
  - [The wrong way: sequential API calls](https://docs.typesafe.ai/demos/smart-home#the-wrong-way-sequential-api-calls)
  - [TypeSafe and LLM pairing](https://docs.typesafe.ai/demos/smart-home#typesafe-and-llm-pairing)
- [Run it yourself](https://docs.typesafe.ai/demos/smart-home#run-it-yourself)
