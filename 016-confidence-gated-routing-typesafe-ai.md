...
- [Example: voice banking commands](https://docs.typesafe.ai/patterns/confidence-routing#example-voice-banking-commands)
  - [Step 1: determine the user’s intent](https://docs.typesafe.ai/patterns/confidence-routing#step-1-determine-the-user%E2%80%99s-intent)
  - [Step 2: confidence-gated routing](https://docs.typesafe.ai/patterns/confidence-routing#step-2-confidence-gated-routing)
