---
title: "Pre-parsed value extraction - TypeSafe AI"
date: "2026-09-16T21:01:13.483Z"
...
image_url: "https://ts-docs.mintlify.app/mintlify-assets/_next/image?url=%2F_mintlify%2Fapi%2Fog%3Fdivision%3DExtraction%26title%3DPre-parsed%2Bvalue%2Bextraction%26description%3DUses%2Bregexes%2Bto%2Bfind%2Bcandidate%2Bemails%252C%2Bphone%2Bnumbers%252C%2Band%2Bamounts%252C%2Bthen%2Bhas%2BTypeSafe%2Bselect%2Bthe%2Brequested%2Bspan%2Bso%2Bcode%2Bcan%2Bnormalize%2Ba%2Bverbatim%2Bvalue.%26theme%3Df0580ae664a0195833f0555d&w=1200&q=100"
image_type: "png"
image_size: 41390
image_height: 630
image_width: 1200
image_size_pretty: "41.4 kB"
word_count: 1977
...
- [Setup](#setup)
- [Helpers](#helpers)
- [Email: pick the right address by role](#email-pick-the-right-address-by-role)
- [Phone: pick the mobile, normalize to E.164](#phone-pick-the-mobile-normalize-to-e164)
- [Money: pick the amount, classify the currency, flag credit vs charge](#money-pick-the-amount-classify-the-currency-flag-credit-vs-charge)
...
*A regex finds the candidate values, TypeSafe picks the one the question asks for, and code copies it verbatim.*

The `find` and `pick` pair here is one you can point at your own documents, and three worked cases show it in use: the address a sender wants their receipt sent to, a phone number as `+14155550177`, and an invoice total as `1315.50 USD` flagged as a charge.

TypeSafe picks one of the options you hand it, so the candidates have to be found first. A regex finds them, TypeSafe picks one, and code copies the pick, in three steps:
...
![Overview diagram](https://mintcdn.com/ts-docs/2NirYCl-v96cw05F/cookbooks/pre_parsed_value_extraction_cookbook/overview.png?fit=max&amp;auto=format&amp;n=2NirYCl-v96cw05F&amp;q=85&amp;s=4df592e42d251f25fe30c2269f2d182a)

Overview diagram

*The regex finds candidate values in the document, TypeSafe picks one, and downstream code normalizes it and acts on it.*
...
[Previous](https://docs.typesafe.ai/cookbooks/date_extraction_cookbook) [Hierarchical classification Next](https://docs.typesafe.ai/cookbooks/hierarchical_classification)
...
- [Setup](https://docs.typesafe.ai/cookbooks/pre_parsed_value_extraction_cookbook#setup)
- [Helpers](https://docs.typesafe.ai/cookbooks/pre_parsed_value_extraction_cookbook#helpers)
- [Email: pick the right address by role](https://docs.typesafe.ai/cookbooks/pre_parsed_value_extraction_cookbook#email-pick-the-right-address-by-role)
- [Phone: pick the mobile, normalize to E.164](https://docs.typesafe.ai/cookbooks/pre_parsed_value_extraction_cookbook#phone-pick-the-mobile-normalize-to-e-164)
- [Money: pick the amount, classify the currency, flag credit vs charge](https://docs.typesafe.ai/cookbooks/pre_parsed_value_extraction_cookbook#money-pick-the-amount-classify-the-currency-flag-credit-vs-charge)
- [Open it in the TypeSafe playground](https://docs.typesafe.ai/cookbooks/pre_parsed_value_extraction_cookbook#open-it-in-the-typesafe-playground)
- [Two limits](https://docs.typesafe.ai/cookbooks/pre_parsed_value_extraction_cookbook#two-limits)
