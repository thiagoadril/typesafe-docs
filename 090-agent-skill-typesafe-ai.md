---
title: "Agent skill - TypeSafe AI"
date: "2026-09-12T05:53:29.732Z"
description: "Drop-in skill for Claude Code, Codex, and other agent environments."
...
image_url: "https://ts-docs.mintlify.app/mintlify-assets/_next/image?url=%2F_mintlify%2Fapi%2Fog%3Fdivision%3DReference%26title%3DAgent%2Bskill%26description%3DDrop-in%2Bskill%2Bfor%2BClaude%2BCode%252C%2BCodex%252C%2Band%2Bother%2Bagent%2Benvironments.%26theme%3Df0580ae664a0195833f0555d&w=1200&q=100"
image_type: "png"
image_size: 33325
image_height: 630
image_width: 1200
image_size_pretty: "33.3 kB"
word_count: 1034
...
- [Good vibe coding principles](#good-vibe-coding-principles)
- [Common issues](#common-issues)
  - [The agent isn’t using the skill](#the-agent-isnt-using-the-skill)
  - [Routing isn’t working like you expect](#routing-isnt-working-like-you-expect)
  - [You’re using confidence thresholds everywhere](#youre-using-confidence-thresholds-everywhere)
  - [It’s difficult to review TypeSafe code](#its-difficult-to-review-typesafe-code)
  - [The agent invents request or response fields](#the-agent-invents-request-or-response-fields)
...
The TypeSafe agent skill gives your AI coding agent full context on the TypeSafe API: the three question [types](https://docs.typesafe.ai/primitives), the architectural [patterns](https://docs.typesafe.ai/patterns), and best practices for structuring evaluations.
...
- Point your agent at a [specific cookbook](https://docs.typesafe.ai/cookbooks/consistency_noul_cookbook) that solves a problem you have in your codebase, or point it at the [cookbooks index](https://docs.typesafe.ai/cookbooks) and ask if there are any patterns that are similar to the ones in your project.
...
[Previous](https://docs.typesafe.ai/api) [Legal Next](https://docs.typesafe.ai/legal)
...
- [Installation](https://docs.typesafe.ai/agent-skill#installation)
  - [Updates](https://docs.typesafe.ai/agent-skill#updates)
- [Example prompts](https://docs.typesafe.ai/agent-skill#example-prompts)
- [Good vibe coding principles](https://docs.typesafe.ai/agent-skill#good-vibe-coding-principles)
- [Common issues](https://docs.typesafe.ai/agent-skill#common-issues)
  - [The agent isn’t using the skill](https://docs.typesafe.ai/agent-skill#the-agent-isn%E2%80%99t-using-the-skill)
  - [Routing isn’t working like you expect](https://docs.typesafe.ai/agent-skill#routing-isn%E2%80%99t-working-like-you-expect)
  - [You’re using confidence thresholds everywhere](https://docs.typesafe.ai/agent-skill#you%E2%80%99re-using-confidence-thresholds-everywhere)
  - [It’s difficult to review TypeSafe code](https://docs.typesafe.ai/agent-skill#it%E2%80%99s-difficult-to-review-typesafe-code)
  - [The agent invents request or response fields](https://docs.typesafe.ai/agent-skill#the-agent-invents-request-or-response-fields)
