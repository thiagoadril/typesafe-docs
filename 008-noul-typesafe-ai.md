...
- [Request](https://docs.typesafe.ai/primitives/noul#request)
- [Response](https://docs.typesafe.ai/primitives/noul#response)
- [Noul does not return a separate confidence value](https://docs.typesafe.ai/primitives/noul#noul-does-not-return-a-separate-confidence-value)
- [Example questions](https://docs.typesafe.ai/primitives/noul#example-questions)
- [Tips and advanced usage](https://docs.typesafe.ai/primitives/noul#tips-and-advanced-usage)
