...
- [Where structure is allowed](https://docs.typesafe.ai/primitives/advanced#where-structure-is-allowed)
- [When to structure a question](https://docs.typesafe.ai/primitives/advanced#when-to-structure-a-question)
...
- [Structured Choice options](https://docs.typesafe.ai/primitives/advanced#structured-choice-options)
  - [JSON rubric for boundary clarification](https://docs.typesafe.ai/primitives/advanced#json-rubric-for-boundary-clarification)
  - [Walking a taxonomy](https://docs.typesafe.ai/primitives/advanced#walking-a-taxonomy)
- [Structured Score levels](https://docs.typesafe.ai/primitives/advanced#structured-score-levels)
