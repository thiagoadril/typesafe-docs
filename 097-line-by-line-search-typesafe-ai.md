---
title: "Line-by-line search - TypeSafe AI"
date: "2026-09-17T20:51:07.422Z"
...
image_url: "https://ts-docs.mintlify.app/mintlify-assets/_next/image?url=%2F_mintlify%2Fapi%2Fog%3Fdivision%3DHow-to%26title%3DLine-by-line%2Bsearch%26description%3DBuild%2Bsemantic%2Bsearch%2Bfor%2BGitHub%2527s%2BTerms%2Bof%2BService.%2BIn%2Bone%2Brequest%252C%2Bscore%2B218%2Bline%2Bids%2Bagainst%2Ba%2Bplain-language%2Bquery%2Bwith%2Ba%2BChoice%2Bquestion%252C%2Band%2Buse%2Ba%2BNoul%2Bqu%26theme%3Df0580ae664a0195833f0555d&w=1200&q=100"
image_type: "png"
image_size: 38614
image_height: 630
image_width: 1200
image_size_pretty: "38.6 kB"
word_count: 2154
...
- [Setup](#setup)
  - [Get a TypeSafe API key](#get-a-typesafe-api-key)
  - [Install the dependencies](#install-the-dependencies)
  - [Create the script](#create-the-script)
- [Step 1: tag every line with an ID](#step-1-tag-every-line-with-an-id)
- [Step 2: ask where the answer is](#step-2-ask-where-the-answer-is)
- [Step 3: check whether an answer exists](#step-3-check-whether-an-answer-exists)
- [Step 4: send both questions in one request](#step-4-send-both-questions-in-one-request)
- [Step 5: read the result](#step-5-read-the-result)
- [Step 6: run the search](#step-6-run-the-search)
- [What the scores mean](#what-the-scores-mean)
- [Try it on your own document](#try-it-on-your-own-document)
...
![A query scans a document and reveals an answer attached to the matching line](https://mintcdn.com/ts-docs/oDyLjm6qxw13db62/cookbooks/semantic_find/semantic-find-hero.gif?s=60d3456a354bc159ac408e4c1aa8c2d2)

A query scans a document and reveals an answer attached to the matching line
...
![A tagged document and user question enter one TypeSafe request. A Choice question scores every line while a Noul question checks whether an answer exists. Local code then ranks the lines and applies the document verdict.](https://mintcdn.com/ts-docs/oDyLjm6qxw13db62/cookbooks/semantic_find/recipe.png?fit=max&amp;auto=format&amp;n=oDyLjm6qxw13db62&amp;q=85&amp;s=ec9af9ffa7c5b4eb0946540143678038)

A tagged document and user question enter one TypeSafe request. A Choice question scores every line while a Noul question checks whether an answer exists. Local code then ranks the lines and applies the document verdict.
...
- [Setup](https://docs.typesafe.ai/cookbooks/semantic_find#setup)
  - [Get a TypeSafe API key](https://docs.typesafe.ai/cookbooks/semantic_find#get-a-typesafe-api-key)
  - [Install the dependencies](https://docs.typesafe.ai/cookbooks/semantic_find#install-the-dependencies)
  - [Create the script](https://docs.typesafe.ai/cookbooks/semantic_find#create-the-script)
- [Step 1: tag every line with an ID](https://docs.typesafe.ai/cookbooks/semantic_find#step-1-tag-every-line-with-an-id)
- [Step 2: ask where the answer is](https://docs.typesafe.ai/cookbooks/semantic_find#step-2-ask-where-the-answer-is)
- [Step 3: check whether an answer exists](https://docs.typesafe.ai/cookbooks/semantic_find#step-3-check-whether-an-answer-exists)
- [Step 4: send both questions in one request](https://docs.typesafe.ai/cookbooks/semantic_find#step-4-send-both-questions-in-one-request)
- [Step 5: read the result](https://docs.typesafe.ai/cookbooks/semantic_find#step-5-read-the-result)
- [Step 6: run the search](https://docs.typesafe.ai/cookbooks/semantic_find#step-6-run-the-search)
- [What the scores mean](https://docs.typesafe.ai/cookbooks/semantic_find#what-the-scores-mean)
- [Try it on your own document](https://docs.typesafe.ai/cookbooks/semantic_find#try-it-on-your-own-document)
